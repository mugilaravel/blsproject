    ...
    <div class="card-body table-responsive p-0">
            ...
            <div class="row text-nowrap">
                ...
                <tr>              
                    ...
                    <td><a href="/training/training/{{$training->id}}/trainingedit" class="btn btn-sm btn-warning">edit</a>
                        <a href="/training/training/{{$training->id}}/trainingdelete" class="btn btn-sm btn-danger" 
